...
export default function SettingsPeers() {
  ...
  const HandleSave = () => {
    if (ConfPath.trim().length !== 0) {
      ...
      loadedYaml.full_node.max_inbound_wallet = FullMaxInboundWallet;
      loadedYaml.full_node.peer_connect_interval = FullPeerConnectInterval;
      loadedYaml.full_node.peer_connect_timeout = FullPeerConnectTimeout;
